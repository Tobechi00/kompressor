...
class HuffmanCompression{
    ...
    std::unordered_map<char, size_t> huffman_length_map;
    ...
    std::unordered_map<char, size_t> &getHuffmanLengthMap();
    ...
    void populateLengthMap(data_structures::TreeNode * huffman_tree, std::unordered_map<char, size_t> &huffman_map, size_t code_length);

    void convertLengthMapToBinary(std::unordered_map<char, size_t> &length_map, std::unordered_map<char, std::string> &huffman_binary_map);
